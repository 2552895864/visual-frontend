...
import provinceGeometry from "./options/map.json";
...
const averageX = 112.53167861914164;
const averageY = 30.887365866279985;
let lastActiveArea;
...
function handleClick(e) {
  ...
  //射线和模型求交，选中一系列直线
  var intersects = raycaster.intersectObjects(group1.children);
...
const Map = ({ destroy }) => {
  ...
  useEffect(() => {
    ...
    if (destroy) {
      const needReset = group1.children.some((g) => g.position.z > 0);
      needReset && handleClick(lastClick);
    }
  }, [destroy]);
  return (
    <div
